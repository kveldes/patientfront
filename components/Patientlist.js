  ...
  .catch(err => console.error(err)); 
      ...
      render() {
        const columns = [{
          ...
          Header: 'CoronaPatient?',
          accessor: 'coronaPatient',
        }, {
          sortable: false,
          filterable: false,
          width: 100,      
          accessor: '_links.self.href',
          Cell: ({value, row}) => (<EditPatient patient={row} link={value} updatePatient={this.updatePatient} fetchPatients={this.fetchPatients} />),
        }, {
          sortable: false,
          filterable: false,
          width: 100,
